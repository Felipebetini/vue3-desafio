<template>
  <div class="page">
    ...
    <div class="wrapper container-fluid">
      <div class="goLeft">
        <img class="arrowLeftImg" src="../assets/arrowLeft.png" />
      </div>
      <div class="card container-fluid" id="card1">
        <img src="../assets/ilove.jpeg" />
        <div class="info">
          <h1>I love you</h1>
          <p>
      ...
      <div class="card container-fluid" id="card2">
      ...
      <div class="card container-fluid" id="card3">
        <img src="../assets/anonymous.jpeg" />
        <div class="info">
      ...
      <div class="goRight">
        <img class="arrowRightImg" src="../assets/arrowRight.png" />
      </div>
    </div>
    <div class="wrapper2 container-fluid" id="card4">
      <div class="goLeft">
        <img class="arrowLeftImg" src="../assets/arrowLeft.png" />
      </div>
      <div class="card">
      ...
      <div class="card container-fluid" id="card5">
      ...
      <div class="card container-fluid" id="card6">
        <img src="../assets/wikileaks.jpeg" />
        <div class="info">
          <h1>WikiLeaks</h1>
          <p>
